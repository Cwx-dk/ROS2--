...
#ifndef BASE_INTERFACES_DEMO__SRV__DETAIL__POSITION__FUNCTIONS_H_
#define BASE_INTERFACES_DEMO__SRV__DETAIL__POSITION__FUNCTIONS_H_
...
/// Initialize srv/Position message.
/**
...
/// Create srv/Position message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces_demo__srv__Position_Request__init().
...
/// Destroy srv/Position message.
/**
 * It calls
 * base_interfaces_demo__srv__Position_Request__fini()
...
/// Check for srv/Position message equality.
/**
...
/// Initialize array of srv/Position messages.
/**
...
/// Finalize array of srv/Position messages.
/**
 * It calls
 * base_interfaces_demo__srv__Position_Request__fini()
...
/// Create array of srv/Position messages.
/**
 * It allocates the memory for the array and calls
 * base_interfaces_demo__srv__Position_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Position messages.
/**
 * It calls
 * base_interfaces_demo__srv__Position_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Position message array equality.
/**
...
/// Copy an array of srv/Position messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces_demo__srv__Position_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces_demo
...
/**
 * It calls
 * base_interfaces_demo__srv__Position_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces_demo
...
/**
 * It allocates the memory for the array and calls
 * base_interfaces_demo__srv__Position_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces_demo
...
/**
 * It calls
 * base_interfaces_demo__srv__Position_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BASE_INTERFACES_DEMO__SRV__DETAIL__POSITION__FUNCTIONS_H_
